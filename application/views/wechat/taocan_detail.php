...
<div id="refreshDiv" class="u-simcard scroller" style="transform: translate3d(0px, -40px, 0px);">
    ...
    <header id="u-top">
        ...
        <div class="head-r">
            <div class="simcard-num"><span><?php echo $taocan['iccid'] ?></span></div>
            <p class="simcard-iccid">ICCID:<span><?php echo $taocan['iccid'] ?></span></p>
    ...
    <div class="simcard-main">
        ...
        <div class="simcard-dated">
            <label>距到期</label><span class="dated-days">
            <?php
            $startdate=strtotime($taocan['expireDate']);
...
//        $expireDate = empty($taocan['expireDate'])?time():$taocan['expireDate'];
                echo $taocan['expireDate']; ?></span>）</div>
